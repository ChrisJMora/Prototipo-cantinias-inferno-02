...
namespace CantuniasInferno
{
    public class PlayerDetector : MonoBehaviour
    {
        ...
        [SerializeField] float detectionRadius = 10f; // Large circle around the enemy
        [SerializeField] float innerdetectRadius = 5f; // Small circle around the enemy
        [SerializeField] float detectionCooldown = 1f; // Time between detections
        [SerializeField] float attackRange = 2f; // Distance to attack the player
        ...
        void Start()
        {
            ...
            detectionStrategy = new ConeDetectionStrategy(detectionAngle, detectionRadius, innerdetectRadius);
        }
        ...
        void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireSphere(transform.position, innerdetectRadius);
